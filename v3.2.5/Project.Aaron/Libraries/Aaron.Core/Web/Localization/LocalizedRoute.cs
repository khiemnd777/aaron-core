...
namespace Aaron.Core.Web.Localization
{
    ...
    public class LocalizedRoute : Route
    {
        ...
        {
            if (DataHelper.DatabaseIsExisted() && this.SeoFriendlyUrlsForLanguagesEnabled)
            {
        ...
        protected bool SeoFriendlyUrlsForLanguagesEnabled
        {
            get
            {
                if (!_seoFriendlyUrlsForLanguagesEnabled.HasValue)
                    _seoFriendlyUrlsForLanguagesEnabled = IoC.Resolve<LocalizationSettings>().SeoFriendlyUrlsForLanguagesEnabled;
