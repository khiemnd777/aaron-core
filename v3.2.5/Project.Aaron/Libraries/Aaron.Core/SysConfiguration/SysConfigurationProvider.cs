...
{
    public class SysConfigurationProvider<TSettings> : ISysConfigurationProvider<TSettings> where TSettings : ISettings, new()
    {
        readonly ISettingService _settingService;

        public SysConfigurationProvider(ISettingService settingService)
        {
