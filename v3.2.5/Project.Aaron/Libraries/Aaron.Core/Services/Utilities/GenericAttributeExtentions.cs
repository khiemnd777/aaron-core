...
namespace Aaron.Core.Services.Utilities
{
    public static class GenericAttributeExtentions
    {
        ...
        public static TPropType GetAttribute<TPropType>(this BaseEntity<int> entity, string key)
        {
            var genericAttributeService = IoC.Resolve<IGenericAttributeService>();
        ...
        /// <returns>Attribute</returns>
        public static TPropType GetAttribute<TPropType>(this BaseEntity<int> entity,
