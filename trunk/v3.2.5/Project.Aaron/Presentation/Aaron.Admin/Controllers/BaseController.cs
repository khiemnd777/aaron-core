...
namespace Aaron.Admin.Controllers
{
    public abstract class BaseController : Controller
    {
        ...
        {
            IoC.Resolve<ICurrentActivity>().IsAdmin = true;
        ...
        private void LogException(Exception exc)
        {
            ...
            var account = currentActivity.CurrentAccount;
            logger.Error(exc.Message, exc, account);
        }
        ...
        {
            string dataKey = string.Format("aaron.notifications.{0}", type);
