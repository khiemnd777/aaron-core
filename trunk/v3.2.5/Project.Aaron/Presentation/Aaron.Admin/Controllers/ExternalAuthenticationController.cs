...
namespace Aaron.Admin.Controllers
{
    ...
    public partial class ExternalAuthenticationController : BaseController
	{
        ...
        public ActionResult Methods()
        {
            ...
            {
                var tmp1 = new AuthenticationMethodModel
                {
        ...
        public ActionResult ConfigureMethod(string systemName)
        {
            ...
            var model = new AuthenticationMethodModel
            {
                DisplayOrder = eam.PluginDescriptor.DisplayOrder,
                FriendlyName = eam.PluginDescriptor.FriendlyName,
                SystemName = eam.PluginDescriptor.SystemName,
            };
