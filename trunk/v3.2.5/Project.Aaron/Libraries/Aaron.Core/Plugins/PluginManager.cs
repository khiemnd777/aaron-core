...
using Aaron.Core.ComponentModel;
            ...
            using (new WriteLockDisposable(Locker))
            {
                ...
                try
                {
                    ...
                    foreach (var dfd in GetDescriptionFilesAndDescriptors(pluginFolder))
                    {
                        ...
                        if (!pluginDescriptor.SupportedVersions.Contains(AaronVersion.CurrentVersion, StringComparer.InvariantCultureIgnoreCase))
                        {
