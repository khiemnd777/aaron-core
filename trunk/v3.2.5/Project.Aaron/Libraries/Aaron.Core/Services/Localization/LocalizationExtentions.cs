...
namespace Aaron.Core.Services.Localization
{
    public static class LocalizationExtentions
    {
            ...
            where T : BaseEntity<int>, ILocalizedEntity
        {
            ...
            return GetLocalized(entity, keySelector, currentActivity.CurrentLanguage.Id);
        }
        /// <summary>
        /// Get localized property of an entity
        /// </summary>
        ...
        public static string GetLocalizedEnum<T>(this T enumValue, ILocalizationService localizationService, ICurrentActivity currentActivity)
            where T : struct
        {
            if (currentActivity == null)
                throw new ArgumentNullException("currentActivity");

            return GetLocalizedEnum<T>(enumValue, localizationService, currentActivity.CurrentLanguage.Id);
        }
        /// <summary>
        /// Get localized value of enum
        /// </summary>
