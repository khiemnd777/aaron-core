...
namespace Aaron.Core.Services.Utilities
{
    ...
    public partial class GenericAttributeService : IGenericAttributeService
    {
        ...
        private const string GENERICATTRIBUTE_KEY = "Aaron.genericattribute.{0}-{1}";
        private const string GENERICATTRIBUTE_PATTERN_KEY = "Aaron.genericattribute.";
        #endregion
        ...
        public virtual void SaveAttribute<TPropType>(BaseEntity<int> entity, string key, TPropType value)
        {
            if (entity == null)
