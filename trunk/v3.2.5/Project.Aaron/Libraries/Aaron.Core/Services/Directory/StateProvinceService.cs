...
namespace Aaron.Core.Services.Directory
{
    ...
    {
        #region Constants
        private const string STATEPROVINCES_ALL_KEY = "Aaron.stateprovince.all-{0}";
        private const string STATEPROVINCES_BY_ID_KEY = "Aaron.stateprovince.id-{0}";
        private const string STATEPROVINCES_PATTERN_KEY = "Aaron.stateprovince.";
        #endregion
