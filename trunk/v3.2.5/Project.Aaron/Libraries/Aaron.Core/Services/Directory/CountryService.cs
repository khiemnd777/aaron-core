...
namespace Aaron.Core.Services.Directory
{
    ...
    {
        #region Constants
        private const string COUNTRIES_ALL_KEY = "Aaron.country.all-{0}";
        private const string COUNTRIES_BY_ID_KEY = "Aaron.country.id-{0}";
        private const string COUNTRIES_PATTERN_KEY = "Aaron.country.";
        #endregion
